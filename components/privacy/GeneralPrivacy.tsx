...
const generalPrivacyHtmlContent = `
    <h2>MOBILE GAME PRIVACY POLICY</h2>
    
    <h5>Privacy Policy</h5>
    <p>İbrahim Atmaca built the Apps as an Ad Supported app. This SERVICE is provided by İbrahim Atmaca at no cost and is intended for use as is.
    This page is used to inform visitors regarding my policies with the collection, use, and disclosure of Personal Information if anyone decided to use my Service.
    If you choose to use my Service, then you agree to the collection and use of information in relation to this policy. The Personal Information that I collect is used for providing and improving the Service. I will not use or share your information with anyone except as described in this Privacy Policy.
    The terms used in this Privacy Policy have the same meanings as in our Terms and Conditions, which is accessible at Play-Earn Money unless otherwise defined in this Privacy Policy.</p>

    <h5>Information Collection and Use</h5>
    <p>For a better experience, while using our Service, I may require you to provide us with certain personally identifiable information, including but not limited to Gsm Model,Sdk Versiyon, Sdk Release,Ip,Country,CountryCode,Location,Gsm Serial Number.
     The information that I request will be retained on your device and is collected by me and stored on our servers and is deleted within 90 days when you are not using the app.
    ...
    <ul>
      ...
      <li><a href="https://gameanalytics.com/privacy" target="_blank" rel="noopener noreferrer">Game Analytics</a></li>
    </ul>
    ...
    <p>I want to inform you that whenever you use my Service, in a case of an error in the app I collect data and information (through third party products) on your phone called Log Data.
     This Log Data may include information such as your device Internet Protocol ("IP") address, device name, operating system version, the configuration of the app when utilizing my Service, the time and date of your use of the Service, and other statistics.</p>
    ...
    <p><strong>Last Update: 02.10.2020</strong></p>
`;

const GeneralPrivacy: React.FC = () => {
  return <PrivacyPolicy title="Mobile Game Privacy Policy" htmlContent={generalPrivacyHtmlContent} />;
};
